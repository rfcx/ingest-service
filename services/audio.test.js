...
describe('Test audio service', () => {
  ...
  test('Can split', async () => {
    ...
    expect(splittedFiles[0].meta.tags).toMatchObject({ encoder: 'Lavf58.29.100' })
    expect(splittedFiles[0].meta.size).toBe(15912)
    expect(splittedFiles[0].meta.checksum).toBe('2c5f3cdd077df413d760daebfe92a54b519f5652')
    ...
    expect(splittedFiles[1].meta.tags).toMatchObject({ encoder: 'Lavf58.29.100' })
    expect(splittedFiles[1].meta.size).toBe(1063917)
    expect(splittedFiles[1].meta.checksum).toBe('efc088a095452ced2fb98b814d149596b315a947')
    ...
    expect(splittedFiles[2].meta.tags).toMatchObject({ encoder: 'Lavf58.29.100' })
    expect(splittedFiles[2].meta.size).toBe(1813608)
    expect(splittedFiles[2].meta.checksum).toBe('d427a4b14ddf9c7fbec739c517d53f1552135072')
    ...
    expect(splittedFiles[3].meta.tags).toMatchObject({ encoder: 'Lavf58.29.100' })
    expect(splittedFiles[3].meta.size).toBe(1853343)
    expect(splittedFiles[3].meta.checksum).toBe('e751ad0e6149e7066597320acc2a0d651520a179')
    ...
    expect(splittedFiles[4].meta.tags).toMatchObject({ encoder: 'Lavf58.29.100' })
    expect(splittedFiles[4].meta.size).toBe(1967523)
    expect(splittedFiles[4].meta.checksum).toBe('3747e9d38ec21d8b271c1bd29bcf514be98fbbd9')
  })
  test('Can convert', async () => {
    ...
    expect(convertedFile.meta.tags).toMatchObject({ encoder: 'Lavf58.29.100' })
    expect(convertedFile.meta.size).toBe(26442970)
    expect(convertedFile.meta.checksum).toBe('c02254e6b55845d408d25963852063304bb2d6a1')
  })
})
