...
describe('Test audio service', () => {
  ...
  test('Can split', async () => {
    ...
    expect(splittedFiles[0].path).toBe(path.join(pathFolder, 'tmp/test-5mins-lv8.000.flac'))
    ...
    expect(splittedFiles[1].path).toBe(path.join(pathFolder, 'tmp/test-5mins-lv8.001.flac'))
    ...
    expect(splittedFiles[2].path).toBe(path.join(pathFolder, 'tmp/test-5mins-lv8.002.flac'))
    ...
    expect(splittedFiles[3].path).toBe(path.join(pathFolder, 'tmp/test-5mins-lv8.003.flac'))
    ...
    expect(splittedFiles[4].path).toBe(path.join(pathFolder, 'tmp/test-5mins-lv8.004.flac'))
  ...
  test('Can convert', async () => {
    ...
    expect(convertedFile.path).toBe(path.join(pathFolder, 'tmp/test-5mins-lv8.wav'))
